...
class NeuralNetwork:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
        ...
        """Trains the neural network with optional verbose and graph outputs.
        ...
        Raises:
            ...
            ValueError: If iterations, step or alpha are not positive
                        or step is not less than or equal to iterations.
        ...
        for i in range(iterations + 1):
            ...
            # Calculate the cost of the current iteration
        ...
        # Return final evaluation after training
        return self.evaluate(X, Y)
